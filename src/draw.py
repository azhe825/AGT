...
###############################################################
    ...
    plt.xlabel("Number of Features")
    plt.legend(bbox_to_anchor=(1.05, 1.0), loc=2, borderaxespad=0.)
    plt.savefig("../fig/result_SVM_unweighted.png")


    "draw"
    plt.figure(num=7,figsize=(16,6))
    plt.subplot(121)
    for is_smote in issmote:
        for method in methods:

            line,=plt.plot(trace_feature_num,Y_median[is_smote][method.__name__]["mean_weighted"],label="median_"+is_smote)
            plt.plot(trace_feature_num,Y_iqr[is_smote][method.__name__]["mean_weighted"],"-.",color=line.get_color(),label="iqr_"+method.is_smote)

    plt.ylabel("Fscore_mu")
    plt.xlabel("Number of Features")
    plt.legend(bbox_to_anchor=(1.05, 1.0), loc=2, borderaxespad=0.)
    plt.savefig("../fig/result_SVM_weighted.png")
    ...
    plt.xlabel("Classes")
    plt.legend(bbox_to_anchor=(1.05, 1.0), loc=2, borderaxespad=0.)
    plt.savefig("../fig/result_SVM_classes.png")
